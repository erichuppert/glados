...
public class ArmControl implements Runnable {
	// Servos
	//
	public static Servo shoulder = new Servo(400,2350,7.0,1400,2075,0,Math.PI/2.0,0);
	public static Servo wrist = new Servo(500,2450,10.0,1750,950,0,Math.PI/2.0,1);
