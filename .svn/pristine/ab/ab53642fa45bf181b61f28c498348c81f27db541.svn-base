...
public class RobotVelocityControllerBalanced extends RobotVelocityController {
  ...
  public void controlStep(double[] controlOutput) {
    ...
    // Begin Student Code
    // Motion Control Lab, Part 11
    
    double wheelAngularVelocityAdjust = gain * angularDiffError;
    ldv = desiredAngularVelocityAvg + wheelAngularVelocityAdjust;
    rdv = desiredAngularVelocityAvg - wheelAngularVelocityAdjust;
    // End Student Code
